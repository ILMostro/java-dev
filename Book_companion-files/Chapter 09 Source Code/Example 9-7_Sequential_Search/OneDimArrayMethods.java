...
public class OneDimArrayMethods
{
                                          ...
                                          int numOfElements)
    {
       ...
       //elemenst of list1 into the correcponding positions in
                                 ...
                                 int tar, int numOfElements)
    {
       ...
       //Method to perform a sequential search on an array.
       //If search item is found, it returns the array position
       //where the search item is found; otherwise it returns -1
